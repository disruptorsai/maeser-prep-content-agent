          ...
          {isLoading ? (
            ...
            <div className="text-center py-12 text-slate-500">
              {posts.length === 0 ? (
                <div className="bg-white p-8 rounded-xl border">
                  ...
                  <p className="text-sm">Use the AI Blog Writer agent to create your first post.</p>
            ...
            <div className="space-y-3">
              {filteredAndSortedPosts.map((post) => (
                <div 
                  key={post.id} 
                  className="p-4 border rounded-xl bg-white hover:bg-slate-50 hover:shadow-md transition-all duration-300 cursor-pointer group relative"
