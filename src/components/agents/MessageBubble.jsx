...
const FunctionDisplay = ({ toolCall }) => {
    ...
    // Note: The original code had `const { toast } = useToast();` here.
    // Since toast is now imported directly from sonner, it's not needed here
    // unless FunctionDisplay itself needs to show toasts, which it currently doesn't.
    // So, no change needed in FunctionDisplay regarding toast.
...
export default function MessageBubble({ message, agent, isTyping }) {
    ...
    // Determine if the message content should be rendered as HTML
                    ...
                    <div className={cn(
                        ...
                        {isUser ? (
                            ...
                            <>
                                ...
                                <div 
                                    className="prose prose-sm max-w-none prose-p:my-1 prose-headings:my-2 message-html-content"
